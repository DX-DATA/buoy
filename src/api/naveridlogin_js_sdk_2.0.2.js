...
!(function (t, n) {
  ...
  return (function (t) {
    ...
    function (t, n, e) {
      var r = e(2),
        ...
        a = function (t, n, e) {
          ...
          d && (e = n);
          for (f in e) (s = !p && m && m[f] !== undefined), (l = (s ? m : e)[f]), (h = y && s ? c(l, r) : g && 'function' == typeof l ? c(Function.call, l) : l), m && u(m, f, l, t & a.U), x[f] != l && o(x, f, h), g && _[f] != l && (_[f] = l);
        };
      ...
      var r = e(1),
        ...
        a = function () {
          var t,
            n = e(93)('iframe'),
            r = o.length;
          for (n.style.display = 'none', e(96).appendChild(n), n.src = 'javascript:', t = n.contentWindow.document, t.open(), t.write('<script>document.F=Object</script>'), t.close(), a = t.F; r--; ) delete a.prototype[o[r]];
          return a();
        };
      t.exports =
        Object.create ||
    ...
    function (t, n, e) {
      ...
      })('versions', []).push({ version: r.version, mode: e(34) ? 'pure' : 'global', copyright: '짤 2019 Denis Pushkarev (zloirock.ru)' });
    },
    function (t, n, e) {
      var r = e(1),
        i = e(10),
    ...
    function (t, n, e) {
      for (var r, i = e(2), o = e(11), u = e(46), c = u('typed_array'), a = u('view'), f = !(!i.ArrayBuffer || !i.DataView), s = f, l = 0, h = 'Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array'.split(','); l < 9; ) (r = i[h[l++]]) ? (o(r.prototype, c, !0), o(r.prototype, a, !0)) : (s = !1);
    ...
    function (t, n, e) {
      ...
      var r = e(9),
        ...
        o = e(6);
      t.exports = function (t) {
        for (var n = r(this), e = o(n.length), u = arguments.length, c = i(u > 1 ? arguments[1] : undefined, e), a = u > 2 ? arguments[2] : undefined, f = a === undefined ? e : i(a, e); f > c; ) n[c++] = t;
        return n;
      };
    },
    function (t, n, e) {
    ...
    function (t, n, e) {
      ...
      (t.exports = function (t, n) {
        return o[t] || (o[t] = n !== undefined ? n : {});
      })('versions', []).push({ version: r.version, mode: e(84) ? 'pure' : 'global', copyright: '짤 2019 Denis Pushkarev (zloirock.ru)' });
    },
    function (t, n, e) {
      var r = e(36),
        i = e(62),
      ...
      t.exports = {
        getConstructor: function (t, n, e, f) {
          ...
          return (
            o(s.prototype, {
              ...
              forEach: function (t) {
                d(this, n);
                for (var e, r = u(t, arguments.length > 1 ? arguments[1] : undefined, 3); (e = e ? e.n : this._f); ) for (r(e.v, e.k, this); e && e.r; ) e = e.p;
              },
              has: function (t) {
                return !!g(d(this, n), t);
              },
        ...
        def: function (t, n, e) {
          var r,
            i,
            o = g(t, n);
          return o ? (o.v = e) : ((t._l = o = { i: (i = p(n, !0)), k: n, v: e, p: (r = t._l), n: undefined, r: !1 }), t._f || (t._f = o), r && (r.n = o), t[v]++, 'F' !== i && (t._i[i] = o)), t;
        },
        getEntry: g,
    ...
    function (t, n, e) {
      ...
      function r(t, n, e, f, s, l, h, p) {
        for (var d, v, g = s, y = 0, m = !!h && c(h, p, 3); y < f; ) {
          if (y in e) {
            if (((d = m ? m(e[y], y, n) : e[y]), (v = !1), o(d) && ((v = d[a]), (v = v !== undefined ? !!v : i(d))), v && l > 0)) g = r(t, n, d, u(d.length), g, l - 1) - 1;
            else {
    ...
    function (t, n, e) {
      ...
      t.exports =
        ...
        e(3)(function () {
          ...
          ? function (t, n) {
              for (var e = c(t), f = arguments.length, s = 1, l = o.f, h = u.f; f > s; ) for (var p, d = a(arguments[s++]), v = l ? i(d).concat(l(d)) : i(d), g = v.length, y = 0; g > y; ) (p = v[y++]), (r && !h.call(d, p)) || (e[p] = d[p]);
              return e;
            }
          : f;
    },
    ...
    function (t, n, e) {
      ...
      var i = e(116),
        ...
        h = (function () {
          function t(n) {
            (0, c['default'])(this, t), (this.age = n.age), (this.birthday = n.birthday), (this.email = n.email), (this.gender = n.gender), (this.id = n.id), (this.name = n.name), (this.nickname = n.nickname), (this.profile_image = n.profile_image), (this.birthyear = n.birthyear), (this.mobile = n.mobile);
          }
          return (
        ...
        s = (function () {
          ...
          return (
            ...
            (t.prototype.setStateTokenToLocal = function (t) {
              var n = !1;
              this.useLocalStorage && (n = (0, f.setLocalStorageValue)(this.stateTokenName, t)), n || (0, a.setCookie)(this.stateTokenName, t, 600, '/');
            }),
            (t.prototype.getStateTokenFromLocal = function () {
              var t = void 0;
              return this.useLocalStorage && (t = (0, f.getLocalStorageValue)(this.stateTokenName)), (t !== undefined && null != t) || (t = (0, a.getCookie)(this.stateTokenName)), t;
            }),
      ...
      (function (n) {
        !(function (n) {
          ...
          (o.prototype = j.constructor = u),
            ...
            (E.mark = function (t) {
              return Object.setPrototypeOf ? Object.setPrototypeOf(t, u) : ((t.__proto__ = u), b in t || (t[b] = 'GeneratorFunction')), (t.prototype = Object.create(j)), t;
            }),
            (E.awrap = function (t) {
              return { __await: t };
            }),
      ...
      var r = e(36),
        ...
        a = function () {
          var t,
            n = e(83)('iframe'),
            r = o.length;
          for (n.style.display = 'none', e(120).appendChild(n), n.src = 'javascript:', t = n.contentWindow.document, t.open(), t.write('<script>document.F=Object</script>'), t.close(), a = t.F; r--; ) delete a.prototype[o[r]];
          return a();
        };
      t.exports =
        Object.create ||
    ...
    function (t, n, e) {
        ...
        A = function (t) {
          y.call(a, function () {
            ...
            if (
              (o &&
                ((n = _(function () {
                  P ? E.emit('unhandledRejection', i, t) : (e = a.onunhandledrejection) ? e({ promise: t, reason: i }) : (r = a.console) && r.error && r.error('Unhandled promise rejection', i);
                })),
                (t._h = P || N(t) ? 2 : 1)),
              (t._a = undefined),
              o && n.e)
      ...
      L ||
        ...
        (r.prototype = e(201)(O.prototype, {
          then: function (t, n) {
            var e = I(g(this, O));
            return (e.ok = 'function' != typeof t || t), (e.fail = 'function' == typeof n && n), (e.domain = P ? E.domain : undefined), this._c.push(e), this._a && this._a.push(e), this._s && j(this, !1), e.promise;
          },
          catch: function (t) {
        ...
        'Array',
        {
          from: function (t) {
            var n,
              ...
              y = 0,
              m = s(h);
            if ((g && (v = r(v, d > 2 ? arguments[2] : undefined, 2)), m == undefined || (p == Array && c(m)))) for (n = a(h.length), e = new p(n); n > y; y++) f(e, y, g ? v(h[y], y) : h[y]);
      ...
      r(
        ...
        'Array',
        {
          slice: function (t, n) {
            ...
            for (var i = u(t, e), f = u(n, e), s = c(f - i), l = new Array(s), h = 0; h < s; h++) l[h] = 'String' == r ? this.charAt(i + h) : this[i + h];
            return l;
          },
        }
      );
    ...
    function (t, n, e) {
      ...
      if (!p(' 0o1') || !p('0b1') || p('+0x1')) {
        ...
        for (var x, _ = e(7) ? f(d) : 'MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger'.split(','), S = 0; _.length > S; S++) i(d, (x = _[S])) && !i(p, x) && l(p, x, s(d, x));
      ...
      r(
        ...
        'Number',
        {
          toFixed: function (t) {
            ...
            return f > 0 ? ((c = y.length), (y = g + (c <= f ? '0.' + u.call('0', f - c) + y : y.slice(0, c - f) + '.' + y.slice(c - f)))) : (y = g + y), y;
          },
        }
      );
    },
          ...
          (v =
            'c' == 'abbc'.split(/(b)*/)[1] || 4 != 'test'.split(/(?:)/, -1)[p] || 2 != 'ab'.split(/(?:ab)*/)[p] || 4 != '.'.split(/(.?)(.?)/)[p] || '.'.split(/()()/)[p] > 1 || ''.split(/.?/)[p]
              ? function (t, n) {
                  ...
                  for (
                    var o, u, c, a = [], s = (t.ignoreCase ? 'i' : '') + (t.multiline ? 'm' : '') + (t.unicode ? 'u' : '') + (t.sticky ? 'y' : ''), l = 0, d = n === undefined ? 4294967295 : n >>> 0, v = new RegExp(t.source, s + 'g');
                    (o = f.call(v, i)) && !((u = v.lastIndex) > l && (a.push(i.slice(l, o.index)), o[p] > 1 && o.index < i[p] && h.apply(a, o.slice(1)), (c = o[0][p]), (l = u), a[p] >= d));
    ...
    function (t, n, e) {
      ...
      var r = e(2),
        ...
        $ = function (t, n, e) {
          return t === W && $(V, n, e), m(t), (n = b(n, !0)), m(e), i(B, n) ? (e.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (e = E(e, { enumerable: w(0, !1) }))) : (i(t, R) || L(t, R, w(1, {})), (t[R][n] = !0)), Y(t, n, e)) : L(t, n, e);
        },
        J = function (t, n) {
          m(t);
      ...
      u(u.S + u.F * !G, 'Symbol', {
        ...
        u(u.S + u.F * !G, 'Object', { create: X, defineProperty: $, defineProperties: J, getOwnPropertyDescriptor: Z, getOwnPropertyNames: tt, getOwnPropertySymbols: nt });
      var ut = f(function () {
        O.f(1);
      });
      u(u.S + u.F * ut, 'Object', {
        ...
        r(
          ...
          'ArrayBuffer',
          {
            slice: function (t, n) {
              ...
              for (var e = u(this).byteLength, r = c(t, e), i = c(n === undefined ? e : n, e), o = new (l(this, h))(a(i - r)), f = new p(this), s = new p(o), d = 0; r < i; ) s.setUint8(d++, f.getUint8(r++));
              return o;
            },
          }
        ),
    ...
    function (t, n, e) {
      ...
      var i = e(19),
        ...
        m = (function () {
          function t(n) {
            (0, o['default'])(this, t), (this.clientId = n.clientId), (this.callbackUrl = n.callbackUrl), (this.isPopup = n.isPopup), (this.state = n.state), (this.userLoginButtons = n.userLoginButtons), (this.version = '2.0.1'), (this.accessToken = null), (this.loginButtonOptions = n.loginButton);
          }
          return (
        ...
        o = (function () {
          ...
          return (
            (t.prototype.makeDefaultOptions = function () {
              (this.options && '' !== this.options) || (this.options = 'titlebar=1, resizable=1, scrollbars=yes'), (this.options += ', width=' + this.width), (this.options += ', height=' + this.height), console.debug('option ' + this.options);
            }),
            (t.prototype.popup = function () {
